...
#Pymongo shenanigans, I actually understand now :)
cluster = pymongo.MongoClient(os.getenv('NOTCONNECTIONSTRING'))
levelling = cluster["disc0"]["honking"]

#So I can have working leaderboard functions, working reactions in the future
...
class Misc(commands.Cog):
  ...
  async def interesting(self, ctx, user:discord.Member = None):
    ...
    draw.text((101,510),f"{ctx.author.display_name} is",(255,255,255), font=font)
